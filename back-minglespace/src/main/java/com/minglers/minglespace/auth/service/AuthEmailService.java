...
//      String uri = "/auth/verify";
      ...
      String emailContent = "<html>"
              ...
              + "<p>안녕하세요! 이메일 인증을 완료하려면 아래 버튼을 클릭하세요:</p>"
              + "<a href='" + confirmationUrl + "' style='display: inline-block; padding: 15px 30px; font-size: 16px; color: #fff; background-color: #4CAF50; text-decoration: none; border-radius: 5px;'>이메일 인증하기</a>"
              + "<p style='margin-top: 20px;'>혹은 아래 링크를 복사하여 브라우저에 붙여넣으세요:</p>"
              + "<p><a href='" + confirmationUrl + "' style='color: #1E88E5;'>" + confirmationUrl + "</a></p>"
              + "<p style='margin-top: 30px;'>감사합니다,<br>이메일 인증팀</p>"
              + "</div>"
              + "</body>"
              + "</html>";
