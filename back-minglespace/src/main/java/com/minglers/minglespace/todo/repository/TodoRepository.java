...
public interface TodoRepository extends JpaRepository<Todo, Long> {
  ...
  Slice<Todo> findByWorkspaceIdAndTitleOrContent(@Param("workspaceId") Long workspaceId, @Param("searchKeyword") String searchKeyword, @Param("sortType") String sortType, Pageable pageable);
  ...
  Slice<Todo> findByWorkspaceIdAndAssigneeName(@Param("workspaceId") Long workspaceId, @Param("assigneeName") String assigneeName, Pageable pageable);
