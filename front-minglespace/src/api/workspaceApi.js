...
//   const res = await axiosInstance.get(`${prefix}/user/${userId}`);
//   console.log("res : ", res);
...
//   const res = await axiosInstance.post(`${prefix}/user/${userId}`, workspaceObj);
...
//   const res = await axiosInstance.delete(`${prefix}/${workspaceId}/user/${userId}`);
//   return res.data;
// };
